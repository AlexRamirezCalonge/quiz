...
router.put('/user/:userId(\\d+)', sessionController.loginRequired, sessionController.timeout, userController.ownershipRequired, userController.update); // actualizar información de cuenta
...
router.get('/user/:userId(\\d+)/quizes', sessionController.timeout, quizController.index); // ver las preguntas de un usuario
